...
task :health do
  queue 'ps aux | grep -v grep | grep -v bash | grep -e "unicorn" -e "mongod" -e "nginx" -e "redis" -e "STAT START   TIME COMMAND" -e "bash"'
end
